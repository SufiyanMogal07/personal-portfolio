    ...
    <header className="container-responsive sticky inset-x-0 top-0 md:top-2 z-60 font-roboto">
      <div className="bg-white/60 border-gray-300 dark:bg-white/10 dark:border-gray-100/20 backdrop-blur-md dark:backdrop-blur-sm shadow-[0_0_20px_rgba(112,100,240,0.2)] border md:rounded-full px-4 md:px-10 py-5 mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center">
          ...
          <div
            className="ml-8 lg:ml-15 border border-gray-200 hover:border-gray-300 hover:bg-gray-100 dark:border-gray-100/10 dark:hover:border-gray-100/20 dark:hover:bg-gray-200/10 transition-colors rounded-md p-1.5 cursor-pointer"
          ...
          <div
            ...
            className="md:hidden ml-4 border border-gray-100/10 hover:border-gray-100/20 hover:bg-gray-200/10 transition-colors rounded-md p-1.5 cursor-pointer"
          >
